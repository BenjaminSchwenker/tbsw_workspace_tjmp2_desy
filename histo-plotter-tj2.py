...
parser.add_argument('--colstart', default=100, type=int, help='Start/Lower column of ROI for efficiency')
parser.add_argument('--colstop', default=200, type=int, help='Stop/Upper column of ROI for efficiency')
parser.add_argument('--rowstart', default=300, type=int, help='Start/Lower row of ROI for efficiency')
